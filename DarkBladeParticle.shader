...
Shader "DarkBladeParticle"
{
	Properties
	{
		...
		_TileOffsetBase("Tile/Offset Base", Vector) = (1,1,0,0)
		_ScrollingBase("Scrolling Base", Vector) = (0,0,0,0)
		[HDR]_SecondaryTint("Secondary Tint", Color) = (1,1,1,1)
		[NoScaleOffset]_MainTex1("Secondary Color", 2D) = "white" {}
		_SecondaryStrength("Secondary Strength", Float) = 1
		_TileOffsetSecondary("Tile/Offset Secondary", Vector) = (1,1,0,0)
		...
		[HideInInspector][Enum()]_Src("Src", Int) = 1
	...
	SubShader
	{
		...
		uniform float4 _TileOffsetBase;
		...
		uniform float4 _TileOffsetSecondary;
		...
		{
			float2 appendResult12 = (float2(_TileOffsetBase.x , _TileOffsetBase.y));
			float2 appendResult13 = (float2(_TileOffsetBase.z , _TileOffsetBase.w));
			float2 uv_TexCoord10 = i.uv_texcoord * appendResult12 + appendResult13;
			...
			float2 appendResult24 = (float2(_TileOffsetSecondary.x , _TileOffsetSecondary.y));
			float2 appendResult25 = (float2(_TileOffsetSecondary.z , _TileOffsetSecondary.w));
			float2 uv_TexCoord23 = i.uv_texcoord * appendResult24 + appendResult25;
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.SamplerNode;5;-755.327,41.20546;Inherit;True;Property;_MainTex;Base Color;7;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;4b1a9ab11cb7da447b1297087c4b2379;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;23;-2147.52,601.3369;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;24;-2351.52,611.3369;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;25;-2350.52,709.3367;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;29;-2145.915,727.5051;Inherit;False;Property;_ScrollingSecondary;Scrolling Secondary;14;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.StaticSwitch;21;-16.14079,102.0434;Inherit;False;Property;_MultiplyAddSecondary;Multiply/Add Secondary;15;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-2850.006,-5.50596;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;12;-3054.006,4.494036;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;13;-3053.006,102.494;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;9;-2604.109,-4.37745;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector4Node;11;-3243.006,-6.505973;Inherit;False;Property;_TileOffsetBase;Tile/Offset Base;8;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;14;-2783.479,116.9527;Inherit;False;Property;_ScrollingBase;Scrolling Base;9;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;35;-2681.168,371.231;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;36;-2429.796,300.3643;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;38;-2826.97,242.8931;Inherit;False;Constant;_Vector0;Vector 0;11;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-3099.75,766.2368;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;46;-2806.541,584.8027;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-3497.083,602.7371;Inherit;False;Property;_DistortionStrength;Distortion Strength;17;0;Create;True;0;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;41;-3545.347,859.8937;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;47;-3384.237,937.3286;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;28;-2663.881,680.2941;Inherit;False;Property;_TileOffsetSecondary;Tile/Offset Secondary;13;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;26;-1819.973,639.7401;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;27;-1274.724,507.7389;Inherit;False;SecondaryUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;49;-1670.924,756.6785;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.StaticSwitch;48;-1555.129,671.3068;Inherit;False;Property;_DistortSecondaryColor;Distort Secondary Color;19;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;7;-673.4811,229.6759;Inherit;False;Property;_Color;Color Tint;6;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;0.8396226,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;62;78.6013,1351.626;Inherit;False;Property;_Dst;Blend Mode;1;1;[Enum];Create;False;0;2;Additive;1;Premultiply;10;0;True;0;False;1;10;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;61;78.20453,1269.749;Inherit;False;Property;_Src;Src;20;2;[HideInInspector];[Enum];Create;True;0;0;0;True;0;False;1;1;False;0;1;INT;0
...
Node;AmplifyShaderEditor.IntNode;51;75.93168,1433.343;Inherit;False;Property;_CullBackfaces;Cull Backfaces;3;0;Create;True;0;0;0;False;0;False;1;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-126.2267,2108.08;Inherit;False;Property;_FadefromCenter;Fade from Center;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-1019.267,601.6767;Inherit;True;Property;_MainTex1;Secondary Color;11;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;22;-1221.911,624.9152;Inherit;False;27;SecondaryUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;93;-996.1068,794.7756;Inherit;False;Property;_SecondaryStrength;Secondary Strength;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-891.6328,1224.156;Inherit;False;Property;_Fresnel;FresnelCulling;5;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;100;-707.6941,779.2053;Inherit;False;Property;_SecondaryTint;Secondary Tint;10;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;34;-2154.991,153.4648;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;33;-2976.31,371.4879;Inherit;True;Property;_Distortion;Distortion;16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;17;-1902.248,147.6759;Inherit;False;MainUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;112;-1152.031,2187.975;Inherit;False;TiledColor;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=527B9451CFE6110092F26B7B899D879A39FA5E21